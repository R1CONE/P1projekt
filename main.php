...
<body>
    <form id="exam-form" method="post">
        <div id="exam-container">
            ...
            <input type="submit" name="submit_button" value="Sprawdź odpowiedzi, powodzenia">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $score_1 = $score;
    $sql = "INSERT INTO results (name, surname, result, klass) VALUES ('$firstname', '$lastname', '$score_1', '$klass')";
